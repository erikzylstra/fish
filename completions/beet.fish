...
set CMDS clearart completion config embedart extractart fetchart fields fingerprint fish ? help imp im import lastgenre ls list mod modify mv move rm remove replaygain scrub stats submit upd up update version write
...
complete -c beet -n '__fish_beet_using_command embedart' -r -s u -l url -f -d 'the URL of the image file to embed'
...
complete -c beet -n '__fish_beet_using_command lastgenre' -s p -l pretend -f -d 'show actions but do nothing'
complete -c beet -n '__fish_beet_using_command lastgenre' -s f -l force -f -d 'modify existing genres'
complete -c beet -n '__fish_beet_using_command lastgenre' -s F -l no-force -f -d "don't modify existing genres"
complete -c beet -n '__fish_beet_using_command lastgenre' -s k -l keep-existing -f -d 'combine with existing genres when modifying'
complete -c beet -n '__fish_beet_using_command lastgenre' -s K -l no-keep-existing -f -d "don't combine with existing genres when modifying"
...
complete -c beet -n '__fish_beet_using_command lastgenre' -s a -l albums -f -d 'match albums instead of items (default)'
complete -c beet -n '__fish_beet_using_command lastgenre' -s d -l debug -f -d 'extended last.fm debug logging'
